...
?>
      <div id="container">
        <div class="main-slider-applyclass">
          <div id="applyclass" class="slider-applyclass col4">
            <!-- 갯수 1개 class="col1" / 갯수 2개 class="col2"  -->
            <ul class="bxslider">
        ...
        <div id="content" class="content">
            ...
            <div class="inner">
              ...
              <div class="f-r">
                <div class="new-schedule">
                  ...
                  <dl>
                    <dt>
                      <strong><em>D-07</em></strong> 2017년 7월 1기 모집
                    </dt>
                    <dd>
                      <p>
                ...
                <div class="new-lecture">
                  ...
                  <ul class="tab-category2">
                    <li class="on">
                      <a href="#"><span>근로자카드</span></a>
                    </li>
                    <!-- class="on" 활성화 -->
                    <li>
                      <a href="#"><span>사업주지원</span></a>
                    </li>
                    <li>
                      <a href="#"><span>일반</span></a>
                    </li>
                  </ul>
                  <div class="tab-category2-con">
                    <ul class="list-bbs">
                      <li>
                        <a href="#">
                          <span class="tc-brand"
                            ><strong>일반직무</strong></span
                          >
                          <span class="sbj ellipsis_line"
                            >부자들이 모르는 35가지 보험 부자들이 모르는 35가지
                            보험</span
                          >
                          <em
                            ><i class="icon-new"
                              ><span class="hidden">new</span></i
                            ></em
                          >
                        </a>
                      </li>
          ...
          <div class="content-section2">
            <div class="inner">
              <span class="tit"
                >직장인 자기개발 교육!
                <strong>해커스와 정부가 수강료를 지원</strong>합니다.</span
              >
              <ul>
                <li>
                  <a href="#"
                    ><img
                      src="http://img.hackershrd.com/main/bnr01.png"
                      alt=""
                      width="324"
                      height="214"
                  /></a>
                ...
                <li>
                  <a href="#"
                    ><img
                      src="http://img.hackershrd.com/main/bnr02.png"
                      alt=""
                      width="324"
                      height="214"
                  /></a>
                ...
                <li>
                  <a href="#"
                    ><img
                      src="http://img.hackershrd.com/main/bnr03.png"
                      alt=""
                      width="324"
                      height="214"
                  /></a>
                ...
                <ul class="list-bbs">
                  <li>
                    <a href="#">
                      ...
                      <span class="sbj ellipsis_line"
                        >부자들이 모르는 35가지 보험 부자들이 부자들이 부자들이
                        모르는 35가지 보험</span
                      >
                      <em>아이디</em>
                    </a>
            ...
            <div class="inner after">
              ...
              <div class="f-r cs-box">
                <div class="cs-info">
                  ...
                  <p>
                    <i class="icon-time"><span class="hidden">운영시간</span></i
                    >평일 9:00 – 23:00/ 주말 9:00 –18:00
                  </p>
                  <p>
                    <i class="icon-email"><span class="hidden">메일</span></i
                    >help@champstudy.com
                  </p>
                </div>
                <div class="after">
          ...
          <div class="quick-bar">
            <div class="inner p-r">
              ...
              <button type="button" class="js_top_scroll">
                <span class="hidden">최상단으로</span>
              </button>
            </div>
          </div>
        </div>
