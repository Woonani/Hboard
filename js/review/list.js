document.addEventListener("DOMContentLoaded", () => {
    ...
    function getRevieweList(pageNum) {
        ...
        fetch(`../../controller/review/list.php?mode=list&page=${pageNum}&tag_no=${tag_no}&col=${col}&word=${word}`)
        .then((res) => {
          return res.json();
        })
        .then((data) => {
...
function getPagingBar(plate) {
    ...
    fetch(`../../controller/review/list.php?plate=${plate}&tag_no=${tag_no}&col=${col}&word=${word}`)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
