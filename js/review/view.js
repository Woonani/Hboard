document.addEventListener("DOMContentLoaded", () => {
 ...
 fetch(`../../controller/review/view.php?mode=view&seq=${seq}`
  ...
  rev_title.innerText = viewInfo.rev_title;
  user_id.innerText = viewInfo.user_id;
  rating.innerText = viewInfo.rating;
  contents.innerText = viewInfo.contents;
  user_id2.innerText = viewInfo.user_id2;
  image_url.innerText = viewInfo.image_url;
  lec_name.innerText = viewInfo.lec_name;
  lec_info.innerText = viewInfo.lec_info;
