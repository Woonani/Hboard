...
<head>
	...
	<script src="./app/js/member.js"></script>
</head>
<body>
	<!-- skip nav -->
	<div id="skip-nav">
	...
	2010년 4월 23일부터 시행되던 종전의 약관은 본 약관으로 대체됩니다. 
						...
						<div class="mt10">
							<label class="input-sp">
								<input type="checkbox" id=member_chk01 value=1/>
								<span class="input-txt" id=member_chk01>약관에 동의합니다.</span>
							</label>
						</div>
					</div>
				</div>
	...
	*이전 개인정보취급방침 보기(2014년 2월 1일부터 시행된 방침) 
						...
						<div class="mt10">
							<label class="input-sp">
								<input type="checkbox" id=member_chk02 value=1/>
								<span class="input-txt" id=member_chk02>약관에 동의합니다.</span>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="all-agree-box">
					<label class="input-sp">
						<input type="checkbox" id=member_chk03 value=1/>
						<span class="input-txt" id=member_chk03>상위 이용약관 및 개인정보 취급방침에 모두 동의합니다.</span>
					</label>
				</div>

				<div class="box-btn">
					<button class="btn-l"  id="member_nxtBtn">다음단계 (휴대폰인증)</button>
					<!-- <a href="#" class="btn-l" >다음단계 (휴대폰인증)</a> -->
				</div>
				<form method="get" name="stipulation_form" action="./01_member_02.php" style="display: none;">
				<!-- <form method="post" name="stipulation_form" action="./member/01_member_02.php" style="display: none;"> -->
					<input type="hidden" name="mode" value="none"/>
					<!-- <input type="hidden" name="member_chk" value="0"/> -->
				</form>
